...
@fraiseql.query(sql_source="v_pageview_event")
def pageview_events(
...
@fraiseql.query(sql_source="v_pageview_aggregate", cache_ttl_seconds=60)
...
@fraiseql.query(sql_source="v_pageview_aggregate", cache_ttl_seconds=300)
