...
SpecQL is a TOML-first schema authoring tool that compiles to FraiseQL Python decorators. It includes 56 semantic scalar types (Email, IBAN, Money, etc.) and is a good fit for teams that want to keep schema definitions separate from application code.
</Aside>
