...
{/* source: Cargo.toml:L343 (workspace.package.version = "2.3.2"). The 2.0.0 tag was never published; current release is 2.3.2. */}
```bash
# Set new image
kubectl set image deployment/fraiseql \
  fraiseql=your-registry/fraiseql:2.3.2 \
  -n fraiseql
