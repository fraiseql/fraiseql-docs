...
{/* source: releasing.md:L625-L645 at frozen SHA d0a4ed4 — Homebrew formula publishing is a Phase 4 "Later" item; no `fraiseql/tap` exists on GitHub (404 on 2026-05-29). */}
