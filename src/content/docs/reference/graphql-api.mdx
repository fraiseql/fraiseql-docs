...
When a mutation has [cascade enabled](/features/function-shapes#graphql-cascade-advanced-mutations-with-side-effects), the response includes all affected entities for automatic client-side cache updates:
