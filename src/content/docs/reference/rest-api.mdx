...
<Aside type="note">
REST transport requires the `rest-transport` Cargo feature. It is included in the published Docker image at `ghcr.io/fraiseql/server:latest`. Configuration via the `[rest]` section in your schema TOML is available since v2.1.
</Aside>
