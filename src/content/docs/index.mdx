...
<CardGrid>
  ...
  <Card title="Starter Templates" icon="open-book">
    [Minimal](/starters/minimal) — SQLite, zero Docker · [Blog API](/starters/blog) — PostgreSQL, posts, comments, tags, mutations · [SaaS](/starters/saas) — multi-tenant with RLS + JWT isolation. One `docker compose up`.
  </Card>
</CardGrid>
