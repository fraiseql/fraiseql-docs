...
<CardGrid>
  ...
  <Card title="TOML Configuration" icon="document">
    Human-readable configuration. No YAML complexity. Your entire backend config fits in one file you can read.
  </Card>
</CardGrid>
...
@fraiseql.query(
    ...
    rest_method="GET",          # gRPC: auto-generated when [grpc] is enabled
)
...
→ REST      http://localhost:8080/rest/v1/  (default path; configure via [rest] path)
...
{/* source: Cargo.toml:L343 (workspace.package.version = "2.3.2") + CHANGELOG.md heading "## [2.3.2] - 2026-05-28" */}
FraiseQL v2.3.2 ships Studio, Functions, Storage, Realtime, and Auth Extensions — see the [release notes](/release-notes/) for the full list of changes.

FraiseQL v2.3.2 is production-ready with comprehensive security, scaling, and integration capabilities.
