...
`fraiseql compile` validates inject key names and source syntax but cannot verify SQL function arity — parameter order is a developer responsibility.
</Aside>
