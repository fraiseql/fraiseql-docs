...
<CardGrid>
  ...
  <Card title="Authentication" icon="approve-check-circle">
    [Authentication](/building/authentication) — JWT, OIDC, and the `[security.*]` compile-step indirection that owns `key_reference`
  </Card>

  <Card title="Deployment" icon="rocket">
    [Deployment](/operations/deployment-guide) — Production key management
  </Card>
</CardGrid>
