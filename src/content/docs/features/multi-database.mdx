...
| Full-text search | Native | ⚠️ Limited | ❌ | ⚠️ Limited |
| Window functions | Full | Full | Limited | Full |
| CTEs | Recursive | Recursive | Recursive | Recursive |
| Subscriptions | LISTEN/NOTIFY | Polling bridge | ❌ | Polling bridge |
...
- [Multi-Tenancy](/guides/multi-tenancy) - Tenant isolation with PostgreSQL RLS
