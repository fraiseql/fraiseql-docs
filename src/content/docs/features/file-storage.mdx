---
title: File Storage
description: File upload, storage, and retrieval with local, S3, GCS, Azure Blob, and European cloud backends
---
...
S3-compatible providers (Cloudflare R2, Scaleway, OVH, Clever Cloud, Exoscale, Infomaniak) use the `s3` backend with a custom `endpoint_env`. See the [S3-compatible configuration](#s3-compatible-services) section below.
...
```bash
export R2_BUCKET=uploads
export R2_ACCESS_KEY_ID=your-access-key
export R2_SECRET_ACCESS_KEY=your-secret-key
export R2_ENDPOINT=https://<account-id>.r2.cloudflarestorage.com
```
</TabItem>
<TabItem label="Scaleway">
```toml
[storage.scaleway]
backend = "s3"
region = "fr-par"
bucket_env = "SCW_BUCKET"
access_key_env = "SCW_ACCESS_KEY"
secret_key_env = "SCW_SECRET_KEY"
endpoint_env = "SCW_ENDPOINT"
```

```bash
export SCW_BUCKET=uploads
export SCW_ACCESS_KEY=your-access-key
export SCW_SECRET_KEY=your-secret-key
export SCW_ENDPOINT=https://s3.fr-par.scw.cloud
```
</TabItem>
<TabItem label="OVH">
```toml
...
backend = "s3"
region = "gra"
bucket_env = "OVH_BUCKET"
access_key_env = "OVH_ACCESS_KEY"
secret_key_env = "OVH_SECRET_KEY"
endpoint_env = "OVH_ENDPOINT"
```

```bash
export OVH_BUCKET=uploads
export OVH_ACCESS_KEY=your-access-key
export OVH_SECRET_KEY=your-secret-key
...
## REST Transport and File Uploads
