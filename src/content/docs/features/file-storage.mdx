...
<Aside type="caution">
Always set `validate_content = true` to validate actual file content rather than trusting the file extension. This prevents malicious uploads disguised as allowed file types.
</Aside>
