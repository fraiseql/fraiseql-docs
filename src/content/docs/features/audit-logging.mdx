...
The exporters are configured programmatically via `AuditLogger::with_exporters()` at server startup. See the [deployment security guide](https://github.com/fraiseql/fraiseql/blob/main/docs/deployment-security-guide.md) for S3/Splunk/Loki integration patterns.
