...
## REST and gRPC Availability

Rich filters are available via REST query parameters and gRPC request fields. Filters defined in your schema translate directly to REST query param syntax and to protobuf request message fields for gRPC.
