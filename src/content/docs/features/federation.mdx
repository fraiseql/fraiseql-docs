...
The built-in federation gateway and full compatibility with Apollo Router are planned for v2.2.0 (Q1 2027). Saga execution across services is production-ready with crash recovery, health checks, and monitoring (SagaExecutor, SagaCompensator, PostgresSagaStore).
:::
