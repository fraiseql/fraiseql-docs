...
<Aside type="tip">
Test your resilience configuration before production by using chaos injection. This helps verify that circuit breakers open and close correctly and that fallbacks work as expected.
</Aside>
