...
│  Application Layer                                                                        │                                                                                           │
│  ┌─────────────────┐                                                                      ↓                                                                                           │
│  │ user.email      │  ← Plaintext (application sees this)  │                                                                                                                          │
↓  │ user.ssn        │                                                                      │                                                                                           │
│  └─────────────────┘                                                                      ↓                                                                                           │
│─────────────────────────────────────────────────────────────                                                                                                                          │
│  FraiseQL Encryption Layer                                                                │                                                                                           │
│  ┌─────────────────┐                                                                      ↓                                                                                           │
│  │ AES-256-GCM     │  ← Automatic encrypt/decrypt          │                                                                                                                          │
│  └─────────────────┘                                                                                                                                                                  │
│─────────────────────────────────────────────────────────────                                                                                                                          │
│  Database Layer                                                                           │                                                                                           │
│  ┌─────────────────┐                                                                      ↓                                                                                           │
│  │ encrypted blob  │  ← Ciphertext (stored encrypted)      │                                                                                                                          │
↓  └─────────────────┘                                                                                                                                                                  ↓
└───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
```bash
curl -X POST http://localhost:8080/admin/encryption/rotate \
