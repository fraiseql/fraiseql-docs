...
<Aside type="tip">
Design webhook handlers to be idempotent. Webhook delivery systems guarantee at-least-once delivery, so duplicate events are possible during failure recovery or retries.
</Aside>
