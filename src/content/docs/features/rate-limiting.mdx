...
| `failed_login_max_attempts` | `10` | Failed attempts before lockout (accepted by CLI; silently dropped by server runtime per [FW-24 #356](https://github.com/fraiseql/fraiseql/issues/356)) |
| `failed_login_lockout_secs` | `900` | 15-minute lockout window (accepted by CLI; silently dropped by server runtime per [FW-24 #356](https://github.com/fraiseql/fraiseql/issues/356)) |
