...
<Aside type="note">
This is a compile-time schema authoring SDK, not a GraphQL client. Requires Elixir 1.14+ and OTP 25+. See [SDK Overview](/sdk) for how the compile→run model works.
</Aside>
