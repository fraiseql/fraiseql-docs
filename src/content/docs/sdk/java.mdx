...
<Aside type="note">
This is a compile-time schema authoring SDK, not a GraphQL client. Kotlin, Scala, Groovy, and Clojure projects can use it via JVM interop. See [SDK Design Philosophy](/concepts/sdk-design) for how the compile→run model works.
</Aside>
