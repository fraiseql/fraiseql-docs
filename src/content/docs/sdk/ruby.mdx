...
<Aside type="note">
The Ruby SDK serves two purposes: (1) an HTTP client for consuming FraiseQL APIs, and (2) a schema authoring mixin for defining types. The HTTP client is production-ready. Schema authoring provides metadata reflection — it does not compile schemas or generate code.
</Aside>
