...
<Aside type="note">
HTTP client for consuming FraiseQL APIs + schema authoring mixin for defining types. See [SDK Design Philosophy](/concepts/sdk-design) for how SDKs fit the compile→run model.
</Aside>
