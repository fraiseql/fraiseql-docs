...
<Aside type="note">
Primarily a compile-time schema authoring SDK — also includes an HTTP client since v2.1.0. See [SDK Design Philosophy](/concepts/sdk-design) for the compile→run model.
</Aside>
