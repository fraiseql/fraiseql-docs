...
<Aside type="note">
The C# SDK is primarily a **schema authoring SDK** — you define APIs, not consume them. However, since v2.1.0 the SDK also includes `FraiseQLClient`, an async HTTP client for consuming FraiseQL APIs from .NET applications. See [HTTP Client](#http-client) below.
</Aside>
