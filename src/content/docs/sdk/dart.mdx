...
<Aside type="note">
Async HTTP client for consuming FraiseQL APIs + schema annotations for defining types. See [SDK Design Philosophy](/concepts/sdk-design) for how SDKs fit the compile→run model.
</Aside>
