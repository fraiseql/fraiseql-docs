...
<Aside type="note">
Async HTTP client for consuming FraiseQL APIs + schema annotations for defining types. See [SDK Overview](/sdk) for how SDKs fit the compile→run model.
</Aside>
...
<Aside type="note">
REST annotation support (`restPath`, `restMethod`) is available in the Dart SDK as of v2.1.0.
</Aside>
