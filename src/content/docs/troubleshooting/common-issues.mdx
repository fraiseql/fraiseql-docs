...
# 5. Cache expensive computations using cache_ttl_seconds= on @fraiseql.query
@fraiseql.query(sql_source="v_expensive", cache_ttl_seconds=3600)
...
**Solutions**:
```python
# 1. Increase TTL using cache_ttl_seconds= on @fraiseql.query
@fraiseql.query(sql_source="v_my_query", cache_ttl_seconds=86400)  # 24 hours instead of 1 hour
