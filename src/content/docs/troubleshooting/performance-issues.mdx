...
**Fix Unbounded Cache**:
```python
# Set TTL to prevent indefinite growth — use cache_ttl_seconds on @fraiseql.query
@fraiseql.query(sql_source="v_expensive_query", cache_ttl_seconds=3600)
...
@fraiseql.query(sql_source="v_stable_data", cache_ttl_seconds=86400)
