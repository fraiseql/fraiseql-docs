...
pool_idle_max_age = 3600000  # Close idle connections after 1 hour
```
...
@fraiseql.query(sql_source="v_order_summary")
...
# FRAISEQL_LOG=debug will log received NATS events.
...
# Define the query with relay=True in the Python schema:
@fraiseql.query(sql_source="v_order", relay=True)
