...
- REST routes follow the pattern `/rest/<resource>` (the default prefix is `/rest`; configure with `[fraiseql.rest]` `prefix`). Check the resource name matches the query or mutation name in your schema.
