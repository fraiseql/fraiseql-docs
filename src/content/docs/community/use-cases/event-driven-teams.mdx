...
description: Emit domain events on database writes without application code changes. FraiseQL's observer system turns every mutation into a NATS or webhook event.
---
