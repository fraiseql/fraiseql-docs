...
{/* source: Cargo.toml:L343 (workspace.package.version = "2.3.2") — placeholder value uses current release so the template models a realistic version field */}
```
Title: Brief description of issue

Environment:
- FraiseQL version: 2.3.2
- Python version: 3.12
