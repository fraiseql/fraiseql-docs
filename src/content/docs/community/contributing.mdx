...
<Aside type="tip">
Post in [GitHub Issues](https://github.com/fraiseql/fraiseql/issues) **before** implementing. This gets feedback on design, ensures alignment with the project direction, and prevents duplicate efforts.
</Aside>
...
- **GitHub Issues**: [Answer in Issues](https://github.com/fraiseql/fraiseql/issues)
...
**GitHub Issues**: [Issues tab](https://github.com/fraiseql/fraiseql/issues) — feature ideas, design discussions, bug reports
