...
<Aside type="caution">
Comparison snapshot as of 2026-05-30 against FraiseQL v2.3.2 (frozen SHA `d0a4ed4e`) and Prisma's then-current stable release. Verify current Prisma state at [prisma.io](https://www.prisma.io/).
</Aside>
...
{/* source: sdks/official/fraiseql-python/src/fraiseql/decorators.py — `@fraiseql.type` / `@fraiseql.query(sql_source="v_<name>")` decorator surface */}
{/* source: crates/fraiseql-cli/src/schema/converter/ — Python-decorator-to-compiled-schema converter (v_ and fn_ mapping) */}
...
<CardGrid>
  <Card title="Prisma Migration Guide" icon="rocket">
    ...
    [Read guide](/building/migrations/from-prisma)
  </Card>
  ...
  <Card title="All Comparisons" icon="list-format">
    ...
    [Compare vs Apollo](/community/vs/apollo)
  </Card>
</CardGrid>
