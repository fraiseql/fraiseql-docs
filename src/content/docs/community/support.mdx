...
- **Categories**: Ideas and Feature Requests, Q&A, Bug Reports, General
...
- [Getting started](/getting-started/introduction) — start here if you are new to FraiseQL
- [Troubleshooting guide](/troubleshooting) — common issues and solutions
- [Contributing guide](/community/contributing) — how to file issues, open PRs, and improve the docs
