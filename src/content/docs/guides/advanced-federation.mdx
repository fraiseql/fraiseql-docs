...
Full compatibility with Apollo Router, federated query planning, and multi-service tracing are planned for v2.2.0 (Q1 2027). Saga execution across services is production-ready — see [Federation](/features/federation) for details.
:::
