...
<Aside type="tip">
FraiseQL includes an `X-FraiseQL-Signature` header (HMAC-SHA256) on every outbound webhook. Verify this header in your endpoint to confirm the request originates from your FraiseQL instance and has not been tampered with.
</Aside>
