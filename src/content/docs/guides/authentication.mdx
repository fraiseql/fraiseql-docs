...
FraiseQL validates authentication tokens automatically — configure your strategy in `fraiseql.toml` and tokens are verified before every request reaches your schema.
