...
Error codes are set via the `HINT` clause of `RAISE EXCEPTION`. FraiseQL maps this to `extensions.code` in the GraphQL error response. See [Error Handling](/guides/error-handling) for the full error code reference.
