...
Full compatibility with Apollo Router, federated query planning, and multi-service tracing are in progress. Saga execution across services is production-ready — see [Federation](/features/federation) for details.
:::
...
See [Federation Gateway Guide](/guides/federation-gateway) for setup and configuration.
