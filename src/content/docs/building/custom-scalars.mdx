...
Custom scalars map to Protobuf types for the gRPC transport. See the [gRPC Transport](/features/grpc-transport/) page for the full GraphQL-to-Protobuf type mapping table.
...
<CardGrid>
  ...
  <Card title="Type System Guide" icon="document">
    [Type System](/concepts/type-system) — How to use scalars inside `@fraiseql.type`
  </Card>
