...
{/* source: CHANGELOG.md (v2.3.0 federation entries); v2.0.1 predated the v2.1.0 release baseline. v2.2.0 shipped on 2026-05-02. */}
...
Full compatibility with Apollo Router, federated query planning, and multi-service tracing are in progress.
:::
...
def inventory_item(sku: str) -> InventoryItem | None:
    ...
    return fraiseql.config(sql_source="v_inventory_item")
