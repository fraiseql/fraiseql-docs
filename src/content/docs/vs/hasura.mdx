...
| **REST transport** | ✅ Annotation-driven, OpenAPI 3.1, HTTP status codes | ⚠️ RESTified Endpoints (wraps a saved GraphQL query; no OpenAPI spec, no HTTP status-code mapping, no request-body parsing) |
