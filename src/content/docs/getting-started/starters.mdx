...
<Aside type="note">
All starter templates serve GraphQL by default. REST and gRPC endpoints are available when you add `rest_path`/`rest_method` and `grpc_service`/`grpc_method` annotations to your schema operations.
</Aside>
