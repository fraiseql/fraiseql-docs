...
- **Schema SDK** (optional): Python 3.10+, Node.js 18+, Go 1.21+, or others
...
This installs the latest binary to `~/.local/bin/fraiseql`.
...
| Linux x86\_64 | `fraiseql-x86_64-unknown-linux-musl.tar.gz` |
...
The schema SDK lets you define GraphQL types in your preferred language. This step is optional — you can write schema directly in TOML.
