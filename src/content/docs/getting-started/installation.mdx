...
<Aside type="caution">
FraiseQL is currently in release-candidate status (rc.13). The core query and mutation APIs are stable. Configuration field names and CLI flags may change between rc versions.
</Aside>
