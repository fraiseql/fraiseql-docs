...
{/* source: releasing.md:L625-L645 at frozen SHA d0a4ed4 — Homebrew formula publishing is a Phase 4 "Later" roadmap item, not yet shipped; formulae.brew.sh/formula/fraiseql.json returned 404 on 2026-05-29. Cargo + binary publishing are confirmed via .github/workflows/release.yml at frozen SHA. */}

| Method | When to choose | macOS | Linux | Windows |
|--------|----------------|:-----:|:-----:|:-------:|
| Install script | Single-line install for a workstation or container | yes | yes | no |
| Pre-built binary | Air-gapped hosts, deterministic provisioning, Windows | yes | yes | yes |
| Cargo | You already have a Rust toolchain and want to track `crates.io` | yes | yes | yes |
...
{/* source: .github/workflows/release.yml at frozen SHA d0a4ed4 — the release pipeline publishes 5-platform binaries to GitHub Releases. */}
...
{/* source: .github/workflows/release.yml:L525-L532 at frozen SHA d0a4ed4 — root `fraiseql` crate is published to crates.io as part of the release pipeline. */}
...
{/* source: Cargo.toml:L343 (workspace.package.version = "2.3.2") + crates/fraiseql/Cargo.toml at frozen SHA d0a4ed4 */}
```text
fraiseql 2.3.2
```
...
<CardGrid>
  <Card title="Manual Setup" icon="rocket">
    [Connect to your own database](/getting-started/quickstart)
  </Card>
