...
With that annotation, the mutation is reachable via REST alongside GraphQL. The default REST path is `/rest/v1`. Configure with `[fraiseql.rest]` `path` to use `/api` or any other value:
