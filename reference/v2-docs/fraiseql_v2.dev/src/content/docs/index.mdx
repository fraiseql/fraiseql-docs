...
<CardGrid>
  <Card title="For Developers" icon="laptop">
    Write views you can read, debug, and explain. No resolver boilerplate. Predictable query plans. Type-safe SDKs in 15 languages.
  </Card>
...
<CardGrid>
  ...
  <Card title="Developer Experience" icon="laptop">
    [🍯 Confiture](/confiture) — database generation & migrations · [Type-safe SDKs](/sdk) in 15+ languages · [TOML configuration](/reference/toml-config) · [Comprehensive CLI](/reference/cli)
  </Card>
</CardGrid>
...
- [Your First Hour](/getting-started/first-hour) — Complete walkthrough with examples
