...
| Operator | Description | SQL |
|----------|-------------|-----|
| `_like` | Pattern match (case-sensitive) | `LIKE $pattern` |
| `_ilike` | Pattern match (case-insensitive) | `ILIKE $pattern` |
| `_nlike` | Not like | `NOT LIKE $pattern` |
| `_nilike` | Not ilike | `NOT ILIKE $pattern` |
| `_regex` | Regular expression | `~ $pattern` |
| `_iregex` | Case-insensitive regex | `~* $pattern` |
| `_nregex` | Not regex | `!~ $pattern` |
| `_niregex` | Not iregex | `!~* $pattern` |
...
| Operator | Description | SQL |
|----------|-------------|-----|
| `_contains` | Array contains value | `@> ARRAY[$value]` |
| `_contained_in` | Array is contained in | `<@ $array` |
| `_has_any` | Has any of values | `&& $array` |
| `_has_all` | Has all of values | `@> $array` |
...
| Operator | Description | SQL |
|----------|-------------|-----|
| `_contains` | Contains JSON | `@> $json` |
| `_contained_in` | Contained in JSON | `<@ $json` |
| `_has_key` | Has key | `? $key` |
| `_has_keys_any` | Has any key | `?| $keys` |
| `_has_keys_all` | Has all keys | `?& $keys` |
