...
| Operator | Description | Example |
|----------|-------------|---------|
| `_amount_gte` | Amount >= | `"10000.00"` |
| `_amount_lte` | Amount <= | `"50000.00"` |
| `_currency_eq` | Currency match | `"USD"` |
| `_converted_gte` | Converted amount >= | `{ amount, currency }` |
...
| `_model_year_gte` | Model year >= | `2020` |
...
| `_is_privileged` | Ports < 1024 | `true` |
...
| `_flight_gte` | Flight number >= | `1000` |
...
| Operator | Description | Example |
|----------|-------------|---------|
| `_gt` | Duration > | `"PT1H"` (1 hour) |
| `_lte` | Duration <= | `"PT30M"` (30 min) |
| `_total_hours_gt` | Total hours > | `1.5` |
| `_total_minutes_lt` | Total minutes < | `30` |
